...
def land_ocean_boxes(meta, cells):
    ...
    *cells* should be an iterator of (weight, land, ocean) triples
    ...
    def itermixed():
        ...
        max_months = (year_max - year_min + 1) * 12
...
def warn_land_ocean(*l):
    ...
    # http://docs.python.org/release/2.4.4/lib/module-warnings.html
    import warnings
    ...
    warnings.warn("Bad mix of land and ocean data.\n"
